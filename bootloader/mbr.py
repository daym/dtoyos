...
data = [
	...
	0xa3, 0x69 - 2 + 8, 0x06, # mov %ax, (...)
	0x8b, 0x47, 0x0a, # mov 10(%bp), %ax
	0xa3, 0x69 - 2 + 10, 0x06, # mov %ax, (...)
	...
	0x89, 0x0e, 0x69 - 2 + 2, 0x06, # mov %cx, (0x065e)
	...
	0xbe, 0x69 - 2, 0x06, # mov $DAP_header -> ds:%si
